...
1.  Pada panel **Buat namespace**, pada tab **Dasar**, lakukan tindakan berikut, dan pilih **Tinjauan + buat**:
...
1.  Tinjauan file **Program.cs**, yang sekarang harus menyertakan kode berikut. Perhatikan bahwa tempat penampung `<storage-connection-string>` mewakili string koneksi ke namespace Azure Service Bus target:
...
1.  Tinjauan metode **Utama**, yang seharusnya terdiri atas kode berikut: 
...
1.  Tinjauan panel **Essentials** dan perhatikan bahwa antrean berisi tiga pesan aktif.
...
1.  Pilih panel **Penjelajah Microsoft Azure Service Bus (pratinjau)** .

1.  Pilih header tab **Mode Intip**, lalu pada tab **Antrean**, pilih tombol **Intip dari awal**.
...
1.  Tinjauan file **Program.cs**, yang sekarang harus menyertakan kode berikut. Tempat penampung `<storage-connection-string>` mewakili string koneksi ke namespace Azure Service Bus target:
