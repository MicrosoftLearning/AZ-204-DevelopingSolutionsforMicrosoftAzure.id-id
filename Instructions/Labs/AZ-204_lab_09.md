...
#### <a name="task-3-review-the-microsofteventgrid-provider-registration"></a>Tugas 3: Tinjauan pendaftaran penyedia Microsoft.EventGrid
...
1. Pada panel **Buat sumber daya**, di kotak teks **Layanan penelusuran dan marketplace**, masukkan **Topik Event Grid**, lalu pilih Enter.
...
1. Pada tab **Tingkat Lanjut**, dari daftar menurun **Skema Peristiwa**, pilih **Skema Event Grid**, lalu pilih **Tinjauan + buat**.
...
1. Pada panel **Buat sumber daya**, di kotak teks **Layanan pencarian dan marketplace**, masukkan **Aplikasi Web**, lalu pilih Enter.
...
1. Pada panel **Buat Aplikasi Web**, pada tab **Dasar**, lakukan tindakan berikut, lalu pilih **Berikutnya: Docker**:
    ...
    | Daftar dropdown **Wilayah**         | Pilih **AS Timur**.                                          |
    | Bagian **Paket Linux (AS Timur)**  | Pilih **Buat baru**, di kotak teks **Nama**, masukkan **EventPlan**, lalu pilih **OK**. |
...
1. Pada tab **Docker**, lakukan tindakan berikut, dan pilih **Tinjauan + buat**:
...
Dalam latihan ini, Anda telah membuat topik Event Grid dan aplikasi web yang akan Anda gunakan di seluruh lab yang tersisa.
...
1. Pada panel **App Service**, dalam kategori **Pengaturan**, pilih tautan **Properti**.
...
1. Pada panel **Buat Langganan Peristiwa**, lakukan tindakan berikut, lalu pilih **Buat**:
    ...
    | Daftar menurun **Skema Peristiwa**  | Pilih **Skema Event Grid**.                                |
    | Daftar menurun **Jenis Titik Akhir** | Pilih **Web Hook**.                                         |
...
1. Tinjauan peristiwa **Microsoft.EventGrid.SubscriptionValidationEvent** yang dibuat sebagai bagian dari proses pembuatan langganan.
...
1. Tinjauan peristiwa **Employees.Registration.New** yang dibuat oleh aplikasi konsol Anda.
...
1. Di portal Microsoft Azure, pilih ikon **Cloud Shell** ![ikon Cloud Shell](./media/az204_lab_CloudShell.png) untuk membuka sesi Bash baru. Jika Cloud Shell default ke sesi PowerShell, pilih **PowerShell** dan, di menu drop-down, pilih **Bash**.
    ...
    > **Catatan**: Jika ini pertama kalinya Anda memulai **Cloud Shell**, saat diminta untuk memilih **Bash** atau **PowerShell**, pilih **PowerShell**. Saat Anda melihat pesan **Anda tidak memiliki penyimpanan yang terinstal**, pilih langganan yang Anda gunakan di lab ini, dan pilih **Buat penyimpanan**.
