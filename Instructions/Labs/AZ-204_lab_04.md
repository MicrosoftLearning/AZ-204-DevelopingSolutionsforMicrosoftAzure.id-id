...
1.  Pada tab **Tinjau + Buat** panel **Buat Akun Azure Cosmos DB - Core (SQL)** , tinjau opsi yang Anda pilih selama langkah sebelumnya. 
...
### <a name="exercise-2-review-and-upload-data"></a>Latihan 2: Tinjau dan unggah data
