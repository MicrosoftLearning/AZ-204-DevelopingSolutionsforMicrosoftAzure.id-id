...
---
# <a name="lab-07-access-resource-secrets-more-securely-across-services"></a>Lab 07: Mengakses rahasia sumber daya dengan lebih aman di seluruh layanan
...
1. Pada panel **Buat akun penyimpanan**, pada tab **Dasar**, lakukan tindakan berikut, dan pilih **Tinjauan + buat**:
...
1.  Pada panel **Buat brankas kunci**, pada tab **Dasar**, lakukan tindakan berikut, lalu pilih **Tinjauan + buat**:

    | Pengaturan                           | Tindakan                                    |
    | --------------------------------- | ----------------------------------------- |
    | Daftar menurun **Langganan**   | Pertahankan nilai default.                 |
    | Daftar menurun **Grup sumber daya** | Pilih **ConfidentialStack** dalam daftar. |
    | Kotak teks **Nama brankas kunci**       | Masukkan **securevault** _[yourname]_ .        |
    | Daftar menurun **Wilayah**         | Pilih **US Timur**.                       |
    | Daftar menurun **Tingkat harga**   | pilih **Standar**.                      |
...
1. Pada panel **Buat Aplikasi Fungsi**, pada tab **Dasar**, lakukan tindakan berikut, lalu pilih **Berikutnya: Hosting**:
    ...
    | --------------------------------- | --------------------------------- |
    | Daftar menurun **Langganan**   | Pertahankan nilai default         |
    | Daftar menurun **Grup sumber daya** | Pilih **ConfidentialStack**     |
    | Kotak teks **Nama Aplikasi Fungsi**    | Masukkan **securefunc** _[yourname]_ |
    | Bagian **Perenerbitan**               | Pilih **Kode** |
    | Daftar menurun **Tumpukan runtime**  | Pilih **.NET** |
    | Daftar dropdown **Versi**        | Pilih **3.1** |
    | Daftar menurun **Wilayah**         | Pilih wilayah **US Timur**. |
    | Tombol radio **sistem operasi** | **Pilih Linux** |
    | Daftar menurun **Jenis paket**      | Pilih **Konsumsi (Tanpa Server)** |


1. Pada tab **Hosting**, lakukan tindakan berikut, lalu pilih **Tinjauan + buat**:
...
1. Pada panel **Explorer** pada jendela **Visual Studio Code**, buka file **local.settings.json**.
...
1. Pada panel **Explorer** dari jendela **Visual Studio Code**, buka file **FileParser.cs**.
...
1. Di jendela pop-up **Ubah tingkat akses**, lakukan tindakan berikut:
    ...
    1. Dalam daftar menurun **Tingkat akses publik**, pilih **Pribadi (tanpa akses anonim)** .
