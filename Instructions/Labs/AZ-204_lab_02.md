...
1. Pada panel **Buat Aplikasi Fungsi**, pada tab **Dasar**, lakukan tindakan berikut, lalu pilih **Berikutnya: Hosting**:
    ...
    | Daftar drop-down **Wilayah**        | Pilih wilayah **AS Timur**.   |
...
1. Di editor kode, amati contoh penerapan:
...
1. Tambahkan baris kode berikut untuk menambahkan **using directives** pada **Microsoft.AspNetCore.Mvc**, **Microsoft.Azure.WebJobs**, **Microsoft.AspNetCore.Http** , dan namespace **Microsoft.Extensions.Logging**:
...
1. Jalankan perintah berikut untuk menjalankan perintah **posting**, mengirimkan isi permintaan HTTP yang diatur ke nilai numerik **3** dengan menggunakan **\-\-content** pilihan:

    ```powershell
    post --content 3
    ```

1. Jalankan perintah berikut untuk menjalankan perintah **posting**, mengirimkan isi permintaan HTTP yang diatur ke nilai numerik **5** dengan menggunakan **\-\-content** pilihan:

    ```powershell
    post --content 5
    ```

1. Jalankan perintah berikut untuk menjalankan perintah **posting**, mengirimkan isi permintaan HTTP yang diatur ke nilai string **Halo** dengan menggunakan **\-\-content** pilihan:

    ```powershell
    post --content "Hello"
    ```

1. Jalankan perintah berikut untuk menjalankan perintah **posting**, mengirimkan isi permintaan HTTP yang diatur ke nilai JavaScript Object Notation (JSON) **{"msg": "Successful"}** dengan menggunakan opsi **\-\-content**:
...
1. Saat menerima perintah buka, jalankan perintah berikut untuk menggunakan **Azure Functions Core Tools** guna membuat fungsi baru bernama **Recurring**, menggunakan template **Timer trigger**:
